(function () {
  ...
  const fluentquick_languages_data = {
    "zh-TW": { code: "zh-TW", name: "繁體中文", threshold: 0.5, priority: 5 },
    en: { code: "en", name: "英文", threshold: 0.5, priority: 6 },
    ja: { code: "ja", name: "日文", threshold: 0.5, priority: 8 },
    ko: { code: "ko", name: "韓文", threshold: 0.5, priority: 9 },
    es: { code: "es", name: "西班牙文", threshold: 0.5, priority: 10 },
    fr: { code: "fr", name: "法文", threshold: 0.5, priority: 11 },
    de: { code: "de", name: "德文", threshold: 0.5, priority: 12 },
    ru: { code: "ru", name: "俄文", threshold: 0.5, priority: 13 },
    it: { code: "it", name: "義大利文", threshold: 0.5, priority: 14 },
    pt: { code: "pt", name: "葡萄牙文", threshold: 0.5, priority: 15 },
    vi: { code: "vi", name: "越南文", threshold: 0.5, priority: 16 },
    th: { code: "th", name: "泰文", threshold: 0.5, priority: 17 },
    id: { code: "id", name: "印尼文", threshold: 0.5, priority: 18 },
    tr: { code: "tr", name: "土耳其文", threshold: 0.5, priority: 19 },
    nl: { code: "nl", name: "荷蘭文", threshold: 0.5, priority: 20 },
    pl: { code: "pl", name: "波蘭文", threshold: 0.5, priority: 21 },
    sv: { code: "sv", name: "瑞典文", threshold: 0.5, priority: 22 },
    uk: { code: "uk", name: "烏克蘭文", threshold: 0.5, priority: 23 },
    ar: { code: "ar", name: "阿拉伯文", threshold: 0.5, priority: 24 },
    he: { code: "he", name: "希伯來文", threshold: 0.5, priority: 25 },
    "zh-CN": { code: "zh-CN", name: "簡體中文", threshold: 0.5, priority: 26 },
  };
  ...
  chrome.storage.local.get("languagesData", (result) => {
    ...
    const languagesData = result.languagesData || fluentquick_languages_data;
